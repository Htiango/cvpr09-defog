...
filename = ['DSC07781.JPG'; 'DSC07658.JPG'; 'DSC07931.JPG'; 'DSC07587.JPG'; 'DSC07622.JPG';'DSC07630.JPG';'DSC07629.JPG'; 'DSC07788.JPG'; 'DSC07760.JPG'; 'DSC07694.JPG'; 'DSC07777.JPG'];
filename =  cellstr(filename);
for i = 1: length(filename)
    filePath = ['example', num2str(i + 7)];
    filePath = [filePath, '/'];
    kenlRatio = .01;
    minAtomsLight = 240;
